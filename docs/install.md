...
```bash
curl -fsSL https://raw.githubusercontent.com/techblack/sim-master/main/install_latest.sh | sh
```

### 国内网络环境

```bash
curl -fsSL https://gh-proxy.com/https://raw.githubusercontent.com/techblack/sim-master/main/install_latest.sh | sh
```

### 可选环境变量

```bash
curl -fsSL https://raw.githubusercontent.com/techblack/sim-master/main/install_latest.sh \
  | REPO=techblack/sim-master INSTALL_DIR=/opt/simadmin SERVICE_NAME=simadmin sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/techblack/sim-master/main/uninstall.sh | sh
```

### 国内网络环境

```bash
curl -fsSL https://gh-proxy.com/https://raw.githubusercontent.com/techblack/sim-master/main/uninstall.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/techblack/sim-master/main/uninstall.sh \
  | sh -s -- --keep-user-data
```
