...
func (s *DialogClientSession) buildReq(req *sip.Request) {
	...
	// ACK and CANCEL keep the INVITE CSeq even when an early-dialog request
	// such as PRACK has already advanced the local dialog sequence. All other
	// in-dialog requests start after the last locally used CSeq.
