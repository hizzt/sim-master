...
// SecureChannelConn identifies a TCP stream whose IP packets are protected by
// a SecuredDataplane. ESP must never be written as payload into this stream;
// the wrapper therefore delegates normal TCP bytes to the netstack.
...
// WrapSecureChannel marks a TCP stream that is protected at the packet layer.
