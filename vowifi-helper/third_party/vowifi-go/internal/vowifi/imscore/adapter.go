...
func (a *VoiceClientAdapter) ProbeSIPOptions(ctx context.Context, input voiceclient.SIPOptionsProbeRequest) (voiceclient.SIPOptionsProbeResult, error) {
	if a == nil || a.inner == nil {
		return voiceclient.SIPOptionsProbeResult{}, voiceclientErr("IMS service not ready")
	}
	return a.inner.ProbeSIPOptions(ctx, input)
}

func (a *VoiceClientAdapter) ProbeSIPEmptyMessage(ctx context.Context, input voiceclient.SIPOptionsProbeRequest) (voiceclient.SIPOptionsProbeResult, error) {
	if a == nil || a.inner == nil {
		return voiceclient.SIPOptionsProbeResult{}, voiceclientErr("IMS service not ready")
	}
	return a.inner.ProbeSIPEmptyMessage(ctx, input)
}
