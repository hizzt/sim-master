...
func TestResolvePCSCFCandidatesOverrideReplacesIKEAddresses(t *testing.T) {
	local := net.ParseIP("2a03:dd00:124e:6119:9648:6f36:6f4c:a215")
	got := resolvePCSCFCandidates(swuSnapshot{
		PCSCFv6: []net.IP{net.ParseIP("2a03:dd00:1f81:810::4")},
	}, "[2a03:dd00:1f80:5060::4]:5060", local)
	want := []string{"[2a03:dd00:1f80:5060::4]:5060"}
