...
import { CellTower, ExpandMore, ExpandLess, Info } from '@mui/icons-material'
import { formatSignalValue, getSignalChipColor } from '../utils'
                ...
                {cellsInfo?.cells && cellsInfo.cells.length > 0 ? (
                  cellsInfo.cells.map((cell, idx) => (
                    ...
                    >
                      ...
                      <TableCell align="right" sx={{ py: 0.5, px: 0.5, fontSize: '0.75rem', fontFamily: '"Geist Mono", monospace' }}>{cell.arfcn || '-'}</TableCell>
                      <TableCell align="right" sx={{ py: 0.5, px: 0.5, fontSize: '0.75rem', fontFamily: '"Geist Mono", monospace' }}>{cell.pci || '-'}</TableCell>
                      ...
                      <TableCell align="right" sx={{ py: 0.5, px: 0.5, fontSize: '0.7rem', fontFamily: '"Geist Mono", monospace' }}>{formatSignalValue(cell.rsrq)}</TableCell>
                      <TableCell align="right" sx={{ py: 0.5, px: 0.5, fontSize: '0.7rem', fontFamily: '"Geist Mono", monospace' }}>{formatSignalValue(cell.sinr)}</TableCell>
                    </TableRow>
                  ))
                ) : (
                  <TableRow>
