...
import { ModemProvider } from './contexts/ModemContext'
...
const VoWifi = lazy(() => import('./pages/VoWifi'))
        ...
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/" element={<ProtectedShell />}>
              ...
              <Route path="modems" element={<Suspense fallback={<PageLoading />}><Modems /></Suspense>} />
              ...
              <Route path="proxy" element={<Suspense fallback={<PageLoading />}><ProxyManager /></Suspense>} />
              <Route path="vowifi" element={<Suspense fallback={<PageLoading />}><VoWifi /></Suspense>} />
