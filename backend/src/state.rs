...
use crate::vowifi_tunnel::VowifiTunnelManager;
...
pub struct AppState {
    ...
    pub vowifi_tunnel_manager: Arc<VowifiTunnelManager>,
...
impl AppState {
    ...
    pub fn new(
        ...
        vowifi_tunnel_manager: Arc<VowifiTunnelManager>,
        ...
        let cell_lock =
            CellLockStore::from_preferences(&config_manager.get_modem_preferences().cell_lock);
        Self {
            dbus_conn,
            database,
            config_manager,
            ...
            cell_lock: Arc::new(Mutex::new(cell_lock)),
            data_user_disabled,
