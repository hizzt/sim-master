...
#[derive(Debug, Default, Serialize)]
pub struct ModemListResponse {
    pub modems: Vec<ModemSummary>,
}
...
pub struct BandLockStatus {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub saved_config: Option<BandLockRequest>,
}
...
pub struct ImsStatusResponse {
    ...
    pub volte_enabled: Option<bool>,
    pub vowifi_supported: Option<bool>,
    pub vowifi_enabled: Option<bool>,
    ...
    pub epdg_resolved: Option<bool>,
    pub sim_aka_command_available: bool,
    pub host_tunnel_supported: bool,
    pub host_tunnel_reason: String,
}
