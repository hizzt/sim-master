...
use crate::{
    config::{
        ...
        BackupStorageConfig, DeviceNetworkConfig, EsimConfig, ModemPreferences, NotificationConfig,
        SecurityConfig, UiPreferences, VersionUpdateNotificationConfig,
    },
    db::Database,
...
struct BackupBaseConfig {
    ...
    #[serde(default)]
    pub modem: Option<ModemPreferences>,
}
